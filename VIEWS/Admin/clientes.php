...
<body>
    ...
    function abrirModalEdicao(id, nome, sexo, telefone, email, dataNasc, endereco) {
        document.getElementById('modalTitulo').textContent = 'Editar Cliente #' + id;
    ...
    function salvarCliente() {
        ...
        if (!nome) {
            mostrarToast('Preencha o nome do cliente!', true);
            return;
        }
    ...
    function excluirCliente(id) {
        enviarRequisicao('apagar', { idCliente: id }, 'excluído', true);
    }
    ...
    function enviarRequisicao(action, dados, acaoNome, isDelete = false) {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                mostrarToast(`Cliente ${acaoNome} com sucesso!`);
                
                if (isDelete) {
                    // Remove a linha da tabela
                    const row = document.querySelector(`tr[data-id="${dados.idCliente}"]`);
                    if (row) row.remove();
    ...
    function atualizarContador() {
        ...
        if (contador) {
            contador.textContent = `Todos os Clientes (${total})`;
        }
